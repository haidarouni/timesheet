...
public class RestControlEmploye {
	...
	@ResponseBody
	public Employe ajouterEmploye(@RequestBody tn.esprit.spring.dto.Employe employe)
	{
		Employe employeEntity = new Employe();
		employeEntity.setEmail(employe.getEmail());
		employeEntity.setActif(employe.isActif());
		employeEntity.setContrat(employe.getContrat());
		employeEntity.setNom(employe.getNom());
		employeEntity.setDepartements(employe.getDepartements());
		employeEntity.setPassword(employe.getPassword());
		employeEntity.setRole(employe.getRole());
		iemployeservice.addOrUpdateEmploye(employeEntity);
	...
	@ResponseBody
	public int ajouterContrat(@RequestBody tn.esprit.spring.dto.Contrat  contrat) {
		
		Contrat contratEntity = new Contrat();
		contratEntity.setDateDebut(contrat.getDateDebut());
		contratEntity.setTypeContrat(contrat.getTypeContrat());
		contratEntity.setEmploye(contrat.getEmploye());
		contratEntity.setSalaire(contrat.getSalaire());
